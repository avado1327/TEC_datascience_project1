...
```{r}
func_results <- data.frame(Presión_de_Saturación = c(Psv(df$Temperatura)), Fugasidad =c(df$Temperatura,df$Presión), Fracción_Molar_VapAgua =c(df$Temperatura,df$Presión,df$Humedad), Fact_Compresibilidad = c(df$Temperatura,df$Presión,df$Humedad))
